...
mixin _$PaginationModel {
 ...
 int get currentPage; int get totalPages; int get totalCount; int get limit; bool get hasNextPage; bool get hasPrevPage;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,currentPage,totalPages,totalCount,limit,hasNextPage,hasPrevPage);

@override
String toString() {
  return 'PaginationModel(currentPage: $currentPage, totalPages: $totalPages, totalCount: $totalCount, limit: $limit, hasNextPage: $hasNextPage, hasPrevPage: $hasPrevPage)';
}
...
@useResult
$Res call({
 int currentPage, int totalPages, int totalCount, int limit, bool hasNextPage, bool hasPrevPage
});
...
/// Create a copy of PaginationModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? currentPage = null,Object? totalPages = null,Object? totalCount = null,Object? limit = null,Object? hasNextPage = null,Object? hasPrevPage = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int currentPage,  int totalPages,  int totalCount,  int limit,  bool hasNextPage,  bool hasPrevPage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PaginationModel() when $default != null:
return $default(_that.currentPage,_that.totalPages,_that.totalCount,_that.limit,_that.hasNextPage,_that.hasPrevPage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int currentPage,  int totalPages,  int totalCount,  int limit,  bool hasNextPage,  bool hasPrevPage)  $default,) {final _that = this;
switch (_that) {
case _PaginationModel():
return $default(_that.currentPage,_that.totalPages,_that.totalCount,_that.limit,_that.hasNextPage,_that.hasPrevPage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int currentPage,  int totalPages,  int totalCount,  int limit,  bool hasNextPage,  bool hasPrevPage)?  $default,) {final _that = this;
switch (_that) {
case _PaginationModel() when $default != null:
return $default(_that.currentPage,_that.totalPages,_that.totalCount,_that.limit,_that.hasNextPage,_that.hasPrevPage);case _:
  return null;
...
class _PaginationModel implements PaginationModel {
  const _PaginationModel({required this.currentPage, required this.totalPages, required this.totalCount, required this.limit, required this.hasNextPage, required this.hasPrevPage});
...
/// Create a copy of PaginationModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? currentPage = null,Object? totalPages = null,Object? totalCount = null,Object? limit = null,Object? hasNextPage = null,Object? hasPrevPage = null,}) {
