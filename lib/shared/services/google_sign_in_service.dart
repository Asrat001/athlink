...
class GoogleAuthService {
  ...
  Future<void> _initializeGoogleSignIn() async {
    String clientId= "127420764973-e5f1vjser07abg4h95l9r6l8facaqvkm.apps.googleusercontent.com";
    if(kDebugMode){
    clientId="127420764973-gkeotfv9v25lodnikmreccva1fulel0l.apps.googleusercontent.com";
    }
    try {
      await _googleSignIn.initialize(
       // Specify required scopes
        clientId: clientId,
        serverClientId: "127420764973-h5cbl6qnsjt2gkcsn31njm44a7tj079c.apps.googleusercontent.com"
      );
