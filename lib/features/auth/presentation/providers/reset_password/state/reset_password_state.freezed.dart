...
mixin _$ResetPasswordState {
 ...
 bool get isLoading; bool get isSuccess; String? get errorMessage; String? get email; String? get token; String? get otp;
...
@override
int get hashCode => Object.hash(runtimeType,isLoading,isSuccess,errorMessage,email,token,otp);

@override
String toString() {
  return 'ResetPasswordState(isLoading: $isLoading, isSuccess: $isSuccess, errorMessage: $errorMessage, email: $email, token: $token, otp: $otp)';
}
...
@useResult
$Res call({
 bool isLoading, bool isSuccess, String? errorMessage, String? email, String? token, String? otp
});
...
/// Create a copy of ResetPasswordState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isLoading = null,Object? isSuccess = null,Object? errorMessage = freezed,Object? email = freezed,Object? token = freezed,Object? otp = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isLoading,  bool isSuccess,  String? errorMessage,  String? email,  String? token,  String? otp)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ResetPasswordState() when $default != null:
return $default(_that.isLoading,_that.isSuccess,_that.errorMessage,_that.email,_that.token,_that.otp);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isLoading,  bool isSuccess,  String? errorMessage,  String? email,  String? token,  String? otp)  $default,) {final _that = this;
switch (_that) {
case _ResetPasswordState():
return $default(_that.isLoading,_that.isSuccess,_that.errorMessage,_that.email,_that.token,_that.otp);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isLoading,  bool isSuccess,  String? errorMessage,  String? email,  String? token,  String? otp)?  $default,) {final _that = this;
switch (_that) {
case _ResetPasswordState() when $default != null:
return $default(_that.isLoading,_that.isSuccess,_that.errorMessage,_that.email,_that.token,_that.otp);case _:
  return null;
...
class _ResetPasswordState implements ResetPasswordState {
  const _ResetPasswordState({this.isLoading = false, this.isSuccess = false, this.errorMessage, this.email, this.token, this.otp});
...
/// Create a copy of ResetPasswordState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isLoading = null,Object? isSuccess = null,Object? errorMessage = freezed,Object? email = freezed,Object? token = freezed,Object? otp = freezed,}) {
