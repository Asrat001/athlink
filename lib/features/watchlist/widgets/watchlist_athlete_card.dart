...
class WatchlistAthleteCard extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<WatchlistAthleteCard> createState() =>
      _WatchlistAthleteCardState();
}

class _WatchlistAthleteCardState extends ConsumerState<WatchlistAthleteCard> {
  bool _isInWatchlist = true; // Always true initially since it's in watchlist
...
class _AthleteDetailOverlayState extends ConsumerState<AthleteDetailOverlay> {
  bool _isInWatchlist = true; // Initially true since it's in watchlist
  bool _isProcessing = false;
