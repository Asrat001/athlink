...
@JsonKey(name: '_id') String get id; String get name; String get email; String get role; String get profileImage;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,email,role,profileImage);

@override
String toString() {
  return 'MessageSender(id: $id, name: $name, email: $email, role: $role, profileImage: $profileImage)';
}
...
@useResult
$Res call({
@JsonKey(name: '_id') String id, String name, String email, String role, String profileImage
});
...
/// Create a copy of MessageSender
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? email = null,Object? role = null,Object? profileImage = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: '_id')  String id,  String name,  String email,  String role,  String profileImage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MessageSender() when $default != null:
return $default(_that.id,_that.name,_that.email,_that.role,_that.profileImage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: '_id')  String id,  String name,  String email,  String role,  String profileImage)  $default,) {final _that = this;
switch (_that) {
case _MessageSender():
return $default(_that.id,_that.name,_that.email,_that.role,_that.profileImage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: '_id')  String id,  String name,  String email,  String role,  String profileImage)?  $default,) {final _that = this;
switch (_that) {
case _MessageSender() when $default != null:
return $default(_that.id,_that.name,_that.email,_that.role,_that.profileImage);case _:
  return null;
...
class _MessageSender implements MessageSender {
  const _MessageSender({@JsonKey(name: '_id') required this.id, this.name = '', required this.email, required this.role, this.profileImage = ''});
...
/// Create a copy of MessageSender
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? email = null,Object? role = null,Object? profileImage = null,}) {
