...
mixin _$JobListState {
 ...
 bool get isLoading; List<JobPostItem> get jobPosts; String? get errorMessage; String? get companyName; String? get companyLogo; bool get isSponsorshipsLoading; List<SponsoredAthleteItem> get sponsoredAthletes; String? get sponsorshipsErrorMessage; bool get isInvitationsLoading; List<InvitationData> get invitations; String? get invitationsErrorMessage;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is JobListState&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&const DeepCollectionEquality().equals(other.jobPosts, jobPosts)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage)&&(identical(other.companyName, companyName) || other.companyName == companyName)&&(identical(other.companyLogo, companyLogo) || other.companyLogo == companyLogo)&&(identical(other.isSponsorshipsLoading, isSponsorshipsLoading) || other.isSponsorshipsLoading == isSponsorshipsLoading)&&const DeepCollectionEquality().equals(other.sponsoredAthletes, sponsoredAthletes)&&(identical(other.sponsorshipsErrorMessage, sponsorshipsErrorMessage) || other.sponsorshipsErrorMessage == sponsorshipsErrorMessage)&&(identical(other.isInvitationsLoading, isInvitationsLoading) || other.isInvitationsLoading == isInvitationsLoading)&&const DeepCollectionEquality().equals(other.invitations, invitations)&&(identical(other.invitationsErrorMessage, invitationsErrorMessage) || other.invitationsErrorMessage == invitationsErrorMessage));
}


@override
int get hashCode => Object.hash(runtimeType,isLoading,const DeepCollectionEquality().hash(jobPosts),errorMessage,companyName,companyLogo,isSponsorshipsLoading,const DeepCollectionEquality().hash(sponsoredAthletes),sponsorshipsErrorMessage,isInvitationsLoading,const DeepCollectionEquality().hash(invitations),invitationsErrorMessage);

@override
String toString() {
  return 'JobListState(isLoading: $isLoading, jobPosts: $jobPosts, errorMessage: $errorMessage, companyName: $companyName, companyLogo: $companyLogo, isSponsorshipsLoading: $isSponsorshipsLoading, sponsoredAthletes: $sponsoredAthletes, sponsorshipsErrorMessage: $sponsorshipsErrorMessage, isInvitationsLoading: $isInvitationsLoading, invitations: $invitations, invitationsErrorMessage: $invitationsErrorMessage)';
}
...
@useResult
$Res call({
 bool isLoading, List<JobPostItem> jobPosts, String? errorMessage, String? companyName, String? companyLogo, bool isSponsorshipsLoading, List<SponsoredAthleteItem> sponsoredAthletes, String? sponsorshipsErrorMessage, bool isInvitationsLoading, List<InvitationData> invitations, String? invitationsErrorMessage
});
...
/// Create a copy of JobListState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isLoading = null,Object? jobPosts = null,Object? errorMessage = freezed,Object? companyName = freezed,Object? companyLogo = freezed,Object? isSponsorshipsLoading = null,Object? sponsoredAthletes = null,Object? sponsorshipsErrorMessage = freezed,Object? isInvitationsLoading = null,Object? invitations = null,Object? invitationsErrorMessage = freezed,}) {
...
as String?,isInvitationsLoading: null == isInvitationsLoading ? _self.isInvitationsLoading : isInvitationsLoading // ignore: cast_nullable_to_non_nullable
as bool,invitations: null == invitations ? _self.invitations : invitations // ignore: cast_nullable_to_non_nullable
as List<InvitationData>,invitationsErrorMessage: freezed == invitationsErrorMessage ? _self.invitationsErrorMessage : invitationsErrorMessage // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isLoading,  List<JobPostItem> jobPosts,  String? errorMessage,  String? companyName,  String? companyLogo,  bool isSponsorshipsLoading,  List<SponsoredAthleteItem> sponsoredAthletes,  String? sponsorshipsErrorMessage,  bool isInvitationsLoading,  List<InvitationData> invitations,  String? invitationsErrorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _JobListState() when $default != null:
return $default(_that.isLoading,_that.jobPosts,_that.errorMessage,_that.companyName,_that.companyLogo,_that.isSponsorshipsLoading,_that.sponsoredAthletes,_that.sponsorshipsErrorMessage,_that.isInvitationsLoading,_that.invitations,_that.invitationsErrorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isLoading,  List<JobPostItem> jobPosts,  String? errorMessage,  String? companyName,  String? companyLogo,  bool isSponsorshipsLoading,  List<SponsoredAthleteItem> sponsoredAthletes,  String? sponsorshipsErrorMessage,  bool isInvitationsLoading,  List<InvitationData> invitations,  String? invitationsErrorMessage)  $default,) {final _that = this;
switch (_that) {
case _JobListState():
return $default(_that.isLoading,_that.jobPosts,_that.errorMessage,_that.companyName,_that.companyLogo,_that.isSponsorshipsLoading,_that.sponsoredAthletes,_that.sponsorshipsErrorMessage,_that.isInvitationsLoading,_that.invitations,_that.invitationsErrorMessage);case _:
  throw StateError('Unexpected subclass');
...
class _JobListState implements JobListState {
  const _JobListState({this.isLoading = false, final  List<JobPostItem> jobPosts = const [], this.errorMessage, this.companyName, this.companyLogo, this.isSponsorshipsLoading = false, final  List<SponsoredAthleteItem> sponsoredAthletes = const [], this.sponsorshipsErrorMessage, this.isInvitationsLoading = false, final  List<InvitationData> invitations = const [], this.invitationsErrorMessage}): _jobPosts = jobPosts,_sponsoredAthletes = sponsoredAthletes,_invitations = invitations;
...
as List<SponsoredAthleteItem>,sponsorshipsErrorMessage: freezed == sponsorshipsErrorMessage ? _self.sponsorshipsErrorMessage : sponsorshipsErrorMessage // ignore: cast_nullable_to_non_nullable
as String?,isInvitationsLoading: null == isInvitationsLoading ? _self.isInvitationsLoading : isInvitationsLoading // ignore: cast_nullable_to_non_nullable
as bool,invitations: null == invitations ? _self._invitations : invitations // ignore: cast_nullable_to_non_nullable
as List<InvitationData>,invitationsErrorMessage: freezed == invitationsErrorMessage ? _self.invitationsErrorMessage : invitationsErrorMessage // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
